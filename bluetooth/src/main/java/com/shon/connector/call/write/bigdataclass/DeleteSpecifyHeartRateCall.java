 ...
 * APP 删除指定的心率数据
 */
public class DeleteSpecifyHeartRateCall extends WriteCallback {
    byte keyValue;
    long time=0L;
    public DeleteSpecifyHeartRateCall(String address, long time) {
        super(address);
        this.time=time;
    }
    public DeleteSpecifyHeartRateCall(String address, byte keyValue) {
        super(address);
    ...
    public byte[] getSendData() {
        ...
        byte[] head={Config.PRODUCT_CODE,0x00,0x01,0x00,0x00,0x00,0x05, HexDump.byteXOR(keyTime),0x02,0x05,0x00,0x04};
