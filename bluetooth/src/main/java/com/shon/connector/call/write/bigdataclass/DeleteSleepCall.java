 ...
 * APP 删除指定的运动数据
 */
public class DeleteSleepCall extends WriteCallback {
    byte keyValue;
    long time=0L;
    public DeleteSleepCall(String address, long time) {
        super(address);
        this.time=time;
    }
    public DeleteSleepCall(String address, byte keyValue) {
        super(address);
    ...
    public byte[] getSendData() {
        ...
        byte[] head={Config.PRODUCT_CODE,0x00,0x01,0x00,0x00,0x00,0x05, HexDump.byteXOR(keyTime),0x02,0x23,0x00,0x04};
